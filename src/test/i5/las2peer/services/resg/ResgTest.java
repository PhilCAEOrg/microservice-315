 ...
 * 315 - Test Class
 *
 * This class provides a basic testing framework for the microservice 315. It was
 * generated by the CAE (Community Application Framework).
 *
 */
public class ResgTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(Resg.class.getCanonicalName(),"0.1");

  private static final String mainPath = "resg";
